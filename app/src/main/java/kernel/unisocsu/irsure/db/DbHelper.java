...
public class DbHelper extends SQLiteOpenHelper {
    ...
    /** Returns true when the codesets table already contains imported data. */
    ...
    /** Compiled insert for one codeset. The primary-key id is generated by SQLite. */
    public SQLiteStatement compileCodesetInsert(SQLiteDatabase db) {
        return db.compileStatement(
                "INSERT INTO codesets (name, brands, model, region) VALUES (?, ?, ?, ?)");
    }

    /** Compiled insert for one function. The primary-key id is generated by SQLite. */
    public SQLiteStatement compileFunctionInsert(SQLiteDatabase db) {
        return db.compileStatement(
                "INSERT INTO functions (codeset_id, func_name, power, mode, temp, fan, swing, freq, pattern) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    }
